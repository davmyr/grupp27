import time
import random
## 1 greet player -> short background story
## 2 prompt to opt in to play
## 3 first part of story and make a choice 

## theme: explore island, run into monsters/scary animals. survive
